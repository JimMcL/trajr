...
```{r, emax_sinuosity, fig.cap="Relationship betwene Emax and Sinuosity", fig.width=6, fig.height=4}
set.seed(1)
n <- 5000
angularErrorSd <- runif(n, 0, 2)
...
dim <- sapply(1:n, function(i) { 
  ...
  TrajFractalDimension(trj, TrajFractalStepSizes(trj))
})
plot(angularErrorSd, dim, xlab = expression(sigma["angular error"]), ylab = expression("E"["max"]))
