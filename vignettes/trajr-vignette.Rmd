...
```{r Emax, fig.cap="Emax as a function of angular error", cache=TRUE, fig.height=4, fig.width=6}
set.seed(1)
n <- 5000
...
```{r Sinuosity, fig.cap="Sinuosity as a function of angular error", cache=TRUE, fig.height=4, fig.width=6}
set.seed(1)
n <- 5000
angularErrorSd <- runif(n, 0, 2)
