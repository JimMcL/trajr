...
```{r echo=FALSE, fig.cap="Figure 1. Steps to constrain a trajectory following our rules", fig.height=7}
...
```{r, fig.cap="Figure 2. Trajectory constrained to a circular arena"}
# Circular arena
...
```{r, fig.cap="Figure 3. Trajectory constrained to an hourglass arena"}
...
```{r, fig.cap="Figure 4. Heatmap of trajectory constrained to an hourglass arena"}
library(MASS)
d <- kde2d(constrained$x, constrained$y, n = 300)
par(mar = c(3, 2, 1, 1) + .1)
image(d, asp = 1)
