...
#' length to 1/10th of the path length, with logarithmically increasing
#' intervals.
#'
...
#'
#' @seealso \code{\link{TrajFractalDimension}}, \code{\link{TrajLogSequence}}
#'
#' @export
TrajFractalStepSizes <- function(trj, smallestStepFactor = .0001, largestStepFactor = .1, numSteps = 20) {
...
#' (\eqn{\delta}). For a fractal curve, \eqn{log(L(\delta))} grows linearly as
#' \eqn{log(\delta)} grows smaller.
#'
#' @param trj Trajectory to calculate fractal dimension for.
#' @param stepSizes Vector of step sizes used to calculate path lengths (see
#'   \code{\link{TrajFractalStepSizes}}).
...
#'
#' @seealso \code{\link{TrajFractalStepSizes}} for a possible calculation of
#'   \code{stepSizes}. \code{\link{TrajFractalDimension}} for fractal dimension
#'   calculation.
#'
#' @examples
#' set.seed(42)
...
#'   path lengths (see \code{\link{TrajFractalStepSizes}}).
...
#'
#' @seealso \code{\link{TrajFractalStepSizes}},
#'   \code{\link{TrajFractalDimensionValues}}.
#'
#' @references Sugihara, G., & M. May, R. (1990). Applications of fractals in
#'   ecology. Trends in Ecology & Evolution, 5(3), 79-86.
...
#'   Ecology, 77(7), 2086-2090. doi:10.2307/2265702
#'
#'   Nams, V. O. (2006). Improving Accuracy and Precision in Estimating Fractal
#'   Dimension of Animal movement paths. Acta Biotheoretica, 54(1), 1-11.
#'   doi:10.1007/s10441-006-5954-8
